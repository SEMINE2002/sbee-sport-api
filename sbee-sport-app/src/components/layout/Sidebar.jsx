...
export default function Sidebar({ isOpen, onClose }) {
  ...
  return (
    ...
    <div key={gi}>
      ...
      <style>{`
        .section-title { font-size: 12px; font-weight: 700; color: #94a3b8; text-transform: uppercase; padding: 15px 20px 5px; letter-spacing: 0.5px; }
        .nav-item { display: flex; align-items: center; gap: 11.5px; padding: 12px 20px; color: #4b5563; text-decoration: none; font-size: 14.5px; transition: all 0.2s ease; border-left: 3px solid transparent; }
